	...
	public void benchmarkPDF2PNGSpeed() throws Exception {
		...
		final class Task implements Runnable {
			...
			public void run() {
				...
				StatementDocumentMessageProducer producer = new StatementDocumentMessageProducer(sequenceGen, ids.incrementAndGet(), NB_CALLS, 60, 0, "b0", false, false, false, false); 				
				try {
