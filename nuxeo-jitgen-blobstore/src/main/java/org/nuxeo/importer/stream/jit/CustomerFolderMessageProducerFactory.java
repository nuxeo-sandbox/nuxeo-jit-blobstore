...
public class CustomerFolderMessageProducerFactory implements ProducerFactory<DocumentMessage> {


	@Override
	public ProducerIterator<DocumentMessage> createProducer(int producerId) {
		return new CustomerFolderMessageProducer(producerId);
	}

	protected String getGroupName(int producerId) {
		return "CustomerFolderMessageProducerFactory." + producerId;
	}
