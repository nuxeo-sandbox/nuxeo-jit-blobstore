...
@Operation(id = AccountProducers.ID, category = Constants.CAT_SERVICES, label = "Produces Bank Statements", since = "11.1", description = "")
public class AccountProducers {
    private static final Log log = LogFactory.getLog(AccountProducers.class);

    public static final String ID = "StreamImporter.runAccountProducers";
